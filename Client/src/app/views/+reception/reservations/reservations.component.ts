  ...
  template: `
    ...
    <section class="page-container">
      ...
      <header class="page-header-container">
        ...
        <div class="page-header-title">Reservación</div>
      </header>
        ...
        <div class="check-table-container mat-elevation-z8">
            <table mat-table  [dataSource]="dataSource">
                ...
                <ng-container matColumnDef="delete">
                    ...
                    <td mat-cell *matCellDef="let x">
                      <button mat-raised-button (click)="deleteReservationById(x.id)" color="warn">
                        <mat-icon>clear</mat-icon>
                      </button>
                    </td>
                </ng-container>
                ...
                <tr mat-header-row *matHeaderRowDef="['initDate', 'endDate', 'room', 'checkin',
                                    'checkout', 'agency', 'guests', 'details', 'delete']; sticky: true"></tr>
                <tr mat-row *matRowDef="let row; columns: ['initDate', 'endDate', 'room', 'checkin',  'checkout',
                                    'agency', 'guests', 'details', 'delete']"></tr>
            </table>
...
export class ReservationsComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    const chid = this.route.snapshot.data.ReservationsResolver;
    if ( chid.error ) {
  ...
  deleteReservationById(id: number): void {
    const dialogRef = this.dialog.open(ConfirmComponent, {
      data: {
        message: `¿Está seguro que desea eliminar esta reservación con id "${id}"?`
      }
    });
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result) {
        ...
        this.api.Delete(id).subscribe(data => {
          if (data.succeeded) {
            this.snackBar.open('Reservación eliminada correctamente', 'X', {duration: 3000});
            this.loading = false;
